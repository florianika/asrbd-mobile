...
class Buildings extends Table {
  ...
  RealColumn get shapeLength => real().nullable()(); // Shape__Length
  RealColumn get shapeArea => real().nullable()(); // Shape__Area
  TextColumn get globalId => text().withLength(min: 1, max: 38)(); // GlobalID

  TextColumn get bldCensus2023 => text().withLength(min: 1, max: 11).nullable().withDefault(const Constant('99999999999'))();
  ...
  TextColumn get bldProperty => text().withLength(min: 1, max: 255).nullable()();
  TextColumn get bldPermitNumber => text().withLength(min: 1, max: 25).nullable()();
  ...
  IntColumn get bldType => integer().nullable().withDefault(const Constant(9))();
  IntColumn get bldClass => integer().nullable().withDefault(const Constant(999))();
  ...
  IntColumn get bldWasteWater => integer().nullable().withDefault(const Constant(9))();
  IntColumn get bldElectricity => integer().nullable().withDefault(const Constant(9))();
  IntColumn get bldPipedGas => integer().nullable().withDefault(const Constant(9))();
  IntColumn get bldElevator => integer().nullable().withDefault(const Constant(9))();
  ...
  IntColumn get bldWaterSupply => integer().nullable().withDefault(const Constant(99))();
