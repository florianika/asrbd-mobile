...
class BuildingDto {
  ...
  Map<String, dynamic> toGeoJsonFeature() {
    return {
      ...
      "attributes": {
        ...
        "BldPermitDate": bldPermitDate?.toIso8601String(),
        "BldStatus": bldStatus,
        ...
        "last_edited_date": lastEditedDate?.toIso8601String(),
        ...
        "external_creator_date": externalCreatorDate?.toIso8601String(),
        "external_editor_date": externalEditorDate?.toIso8601String(),
      }
    };
  }
  ...
  factory BuildingDto.fromGeoJsonFeature(Map<String, dynamic> feature) {
    ...
    return BuildingDto(
      objectId: safeInt(props['OBJECTID'] ?? feature['id']) ?? 0,
      geometryType: type,
      coordinates: coords,
