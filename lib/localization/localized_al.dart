...
class LocalizedAl {
  static final Map<String, String> localizedStrings = {
    ...
    Keys.dwellingQualityErrorFree: 'Pa gabime',
    Keys.dwellingQualityStatisticalErrorFree: 'Statistikore pa gabime',
    Keys.dwellingQualityStatisticalGaps: 'Mungesa në të dhëna statistikore',
    Keys.dwellingQualityStatisticalInconsistent: 'Statistikore kontradiktore',
    Keys.dwellingQualityNotReadyForStatistics: 'Jo e gatshme për statistika',
