...
class _DownloadPreplannedMapAreaState extends State<DownloadPreplannedMapArea>  implements ArcGISAuthenticationChallengeHandler
    {
  ...
  void downloadOfflineMap(PreplannedMapArea mapArea) async {
    ...
    defaultDownloadParams.updateMode = PreplannedUpdateMode.syncWithFeatureServices;
