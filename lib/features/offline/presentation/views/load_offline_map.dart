...
class LoadOfflineMap extends StatefulWidget {
  const LoadOfflineMap({super.key});

  @override
  State<LoadOfflineMap> createState() => _LoadOfflineMapState();
}

class _LoadOfflineMapState extends State<LoadOfflineMap> implements ArcGISAuthenticationChallengeHandler{
